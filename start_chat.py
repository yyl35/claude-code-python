            ...
            for line in f:
                ...
                if line and not line.startswith('#') and '=' in line:
                    ...
                    if "KEY" in key or "SECRET" in key:
                        ...
                        print(f"  设置: {key.strip()}={value.strip()}")
    else:
...
async def main():
    ...
    try:
        ...
        print("=" * 60)
        print("\n访问地址:")
        print("  [Web] Web界面: http://localhost:8004")
        print("  [健康] 健康检查: http://localhost:8004/api/health")
        print("  [状态] 状态信息: http://localhost:8004/api/status")
        print("\n使用说明:")
        print("  1. 打开浏览器访问 http://localhost:8004")
        print("  2. 在聊天框中输入任务")
        print("  3. 按回车或点击发送按钮")
        print("  4. 等待代理处理并返回结果")
        print("\n示例任务:")
...
if __name__ == "__main__":
    try:
        ...
        print("\n\n注意: 控制台编码问题，建议使用支持UTF-8的终端（如Windows Terminal）")
        print("或者直接访问: http://localhost:8001")
        sys.exit(0)